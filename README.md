...
- Ответы на вопросы студентов через базу знаний и OpenAI.
...
## Ответы на вопросы (база знаний + OpenAI)
По умолчанию используется файл `knowledge_base.md`. Бот отвечает на любые текстовые вопросы, если включён `qa.enabled=true` и задан `qa.openai_api_key`.
